...
public class LivestockcategoryServiceImpl implements LivestockcategoryService {
     ...
     */
    private static final String AUDIT_ENTITY_NAME = "livestockcategory";
    ...
    @Override
    public CustomResponse createLivestockcategory(JsonNode livestockcategoryEntity) {
    ...
    @Override
    public CustomResponse searchLivestockcategory(SearchCriteria searchCriteria) {
    ...
    @Override
    public CustomResponse draftLivestockcategory(JsonNode livestockcategoryEntity) {
    ...
    @Override
    public CustomResponse addLivestockcategory(String id, JsonNode livestockcategoryEntity) {
    ...
    @Override
    public CustomResponse approveLivestockcategory(LifecycleRequest request) {
    ...
    @Override
    public CustomResponse reviewLivestockcategory(LifecycleRequest request) {
