...
public class CropvarietyServiceImpl implements CropvarietyService {
    ...
    private static final String AUDIT_ENTITY_NAME = "cropvariety";
    ...
    public CustomResponse createCropvariety(JsonNode cropvarietyEntity) {
        ...
        try {
            ...
            ObjectNode jsonNode = buildDocument(cropvarietyEntity, Constants.PENDING, currentTime, currentTime);
    ...
    @Override
    public CustomResponse draftCropvariety(JsonNode cropvarietyEntity) {
    ...
    @Override
    public CustomResponse addCropvariety(String id, JsonNode cropvarietyEntity) {
    ...
    @Override
    public CustomResponse approveCropvariety(LifecycleRequest request) {
    ...
    @Override
    public CustomResponse reviewCropvariety(LifecycleRequest request) {
