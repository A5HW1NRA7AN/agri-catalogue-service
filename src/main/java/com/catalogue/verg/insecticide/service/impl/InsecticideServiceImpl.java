...
public class InsecticideServiceImpl implements InsecticideService {
    ...
    private static final String AUDIT_ENTITY_NAME = "insecticide";
    ...
    public CustomResponse createInsecticide(JsonNode insecticideEntity) {
        ...
        try {
            ...
            ObjectNode jsonNode = buildDocument(insecticideEntity, Constants.PENDING, currentTime, currentTime);
    ...
    @Override
    public CustomResponse draftInsecticide(JsonNode insecticideEntity) {
    ...
    @Override
    public CustomResponse addInsecticide(String id, JsonNode insecticideEntity) {
    ...
    @Override
    public CustomResponse approveInsecticide(LifecycleRequest request) {
    ...
    @Override
    public CustomResponse reviewInsecticide(LifecycleRequest request) {
